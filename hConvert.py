...
if __name__ == "__main__":
    ...
    converter ='/afs/cern.ch/user/g/govoni/work/PHANTOM/phantom_at_cern/LHEActions/muToEleInLHE'

    inputFolder      = sys.argv[1]
    outputBaseFolder = os.path.abspath (sys.argv[2])
    outputUUFolder = outputBaseFolder + '/' + inputFolder + '_UU'
    outputEEFolder = outputBaseFolder + '/' + inputFolder + '_EE'
